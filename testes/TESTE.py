...
PALAVRA = str(input('PALAVRA: ')).upper()
PALAVRA_cripto = hill_criptografia(PALAVRA, chave)
print(PALAVRA_cripto)

PALAVRA_DEScripto = hill_criptografia(PALAVRA_cripto, chave_inversa)
print(PALAVRA_DEScripto)